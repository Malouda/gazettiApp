...
class ReaderCoverPageMenu extends React.Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        ...
        drawerLabel: 'Cover Pages',
        headerTintColor: '#fff',
        drawerIcon:()=>(
            <Icon2 name="file-image" size={25} color="#fff" />
        ),
    ...
    selectPublication(id){
        ...
        this.props.navigateTo('ReaderViewCoverPage');
    }
...
export default connect(mapStateToProps,mapDispatchToProps)(ReaderCoverPageMenu)
