...
class createPublicationComponent extends React.Component{
    ...
    componentWillMount (){
        ...
        this.setState({
            publisher:this.props.selectedPublication.publisher_id,
            publicationName:this.props.selectedPublication.publication_name,
            type_id:this.props.selectedPublication.type_id,
            language_id:this.props.selectedPublication.language_id,
            perspective_id:this.props.selectedPublication.perspective_id,
            description:this.props.selectedPublication.description,
            weekly:this.props.selectedPublication.weekly,
            daily:this.props.selectedPublication.daily,
            minimumHeadlines:this.props.selectedPublication.minimum_headlines.toString(),
            maximumHeadlines:this.props.selectedPublication.maximum_headlines.toString(),
            logo_url:this.props.selectedPublication.logo_url,
            notification_email:this.props.selectedPublication.email,
        });

        this.props.insertImageUploadUrlAction(this.props.selectedPublication.logo_url);
    ...
    createPublication(){
        ...
        let data={
            ...
            publication_id:this.props.selectedPublication.id
        };
