...
class EmployeeCoverPageMenu extends React.Component{
                    ...
                    <View style={uStyles.row}>
                        <View style={uStyles.buttonContainer}>
                            <View style={uStyles.buttonSubContainer}>
                                <TouchableOpacity style={uStyles.dashBoardbutton} onPress={()=>this.props.navigateTo('UploadCoverPageComponent')}>
                                    <Text style={uStyles.dashBoardButtonText}>Upload Cover Page</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={uStyles.buttonContainer}>
                            <View style={uStyles.buttonSubContainer}>
                                <TouchableOpacity style={uStyles.dashBoardbutton} onPress={()=>this.props.navigateTo('EmployeePublicationList')}>
...
export default connect(mapStateToProps,mapDispatchToProps)(EmployeeCoverPageMenu)
