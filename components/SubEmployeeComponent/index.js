...
class SubEmployeeComponent extends React.Component{
    ...
    static navigationOptions = ({ navigation }) => ({
        headerTitle:'Sub Employee Dashboard',
...
export default connect(mapStateToProps,mapDispatchToProps)(SubEmployeeComponent)
