...
import registerReaderAction from '../../actions/user/registerReaderAction';
    ...
    register(){
        ...
        if(register){
            ...
            if(this.state.password === this.state.passwordConfirm){
                ...
                this.props.registerReaderAction(data).then((x)=>{
...
export default connect(mapStateToProps,mapDispatchToProps)(UserRegistrationComponent)
